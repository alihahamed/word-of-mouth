...
const SERVICES = [
  {
    title: 'GRAPHIC\nDESIGN',
    text: "Your brand's first impression lives or dies on visuals. We craft identities that stop the scroll - logos, print, and brand assets that actually look like you, not a template.",
    tag: 'Brand Identity',
    personalLine: 'You get designer-level polish with founder-level context in every revision.',
    statLabel: 'Recent result',
    statValue: '+41% profile saves',
    outcomes: ['Logo system', 'Brand toolkit', 'Print-ready assets'],
    bg: 'bg-black',
    textColor: 'text-white',
  },
  {
    title: 'SOCIAL MEDIA\nMARKETING',
    text: "Posting isn't a strategy. We build content ecosystems that grow your audience, speak to the right people, and make your brand impossible to ignore online",
    tag: 'Content Growth',
    personalLine: 'We build around your voice, then coach your team so content still sounds like you.',
    statLabel: 'Recent result',
    statValue: '3.2x reach in 8 weeks',
    outcomes: ['Content calendar', 'Hook-first scripts', 'Community playbook'],
    bg: 'bg-[#ff1493]',
    textColor: 'text-black',
  },
  {
    title: 'GOOGLE ADS\nSTRATEGY',
    text: "We don't guess with your budget. Every campaign is built on real data, tight targeting, and copy that converts - so your money goes where it actually works.",
    tag: 'Paid Acquisition',
    personalLine: 'You see exactly where spend goes and why each optimization decision gets made.',
    statLabel: 'Recent result',
    statValue: '-28% CPL in 30 days',
    outcomes: ['Intent map', 'Ad copy testing', 'Weekly optimization'],
    bg: 'bg-[#fee12b]',
    textColor: 'text-black',
  },
]
